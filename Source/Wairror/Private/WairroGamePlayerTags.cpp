...
namespace WairroGamePlayerTags {
	...
	UE_DEFINE_GAMEPLAY_TAG(Enemy_Ability_Randge, "Enemy.Ability.Randge");
	...
	/** Game Data tags **/
	UE_DEFINE_GAMEPLAY_TAG(GameData_Level_SurvialGameModeMap, "GameData.Level.SurvialGameModeMap");
